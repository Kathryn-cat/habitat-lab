...
from habitat.tasks.expl.utils import CollDetails, rearrange_collision

@registry.register_task(name="ExplTask-v0")
class ExplTask(NavigationTask):
    """
    ...
    def _check_episode_is_active(
        ...
        **kwargs: Any,
        ...
        from habitat.tasks.expl.expl_sensors import (
